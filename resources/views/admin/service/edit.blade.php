                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" class="form-control" id="service_id" name="service_id" value="{{$data->id}}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="code">Service ID</label>
                                <input type="number" class="form-control" id="code" name="code" value="{{$data->code}}">
                            </div>
                    ...
                    <tbody id="inner">
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" id="productname" name="productname[]" value="{{ $item->product->productname }}" class="form-control" readonly>
                                <input type="hidden" id="product_id" name="product_id[]" value="{{ $item->product_id }}" class="form-control ckproduct_id" readonly>
                                <input type="hidden" id="service_detail_id" name="service_detail_id[]" value="{{ $item->id }}" class="form-control" readonly>
                            </td>
                            <td class="text-center">
                                <input type="number" id="quantity" name="quantity[]" value="{{ $item->quantity }}" min="1" class="form-control quantity">
                            </td>
                            <td class="text-center"><div style="color: white;  user-select:none;  padding: 5px;    background: red;    width: 45px;    display: flex;    align-items: center; margin-right:5px;   justify-content: center;    border-radius: 4px;   left: 4px;    top: 81px;" onclick="removeRow(event)" >X</div></td>
                        </tr>
...
<script>
    $(document).ready(function() {
        ...
        // submit to purchase 
        var purchaseurl = "{{URL::to('/admin/update-services')}}";
        ...
        $("body").delegate("#purchaseBtn", "click", function(event) {
            ...
            var service_detail_id = $("input[name='service_detail_id[]']")
                .map(function() {
                    return $(this).val();
                }).get();
