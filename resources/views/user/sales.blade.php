        ...
        <div class="row gx-2">
            ...
            <div class="col-lg-3 ">
                ...
                <div class="box">
                    <form action="">
                        <div class="row">
                            <p  class="box-title" >Sales/Quotation/Delivery Note</p>
                            <div class="row">
                                <div class="col-lg-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mx-1">
                                                    ...
                                                    <input type="text" id="showcustomervehicleno" class="form-control ">
                                                </div>
                                                <div class="form-group mx-1">
                                                    <label for=""> Name</label>
                                                    <input type="text" id="showcustomername" class="form-control ">
                                                    <input type="hidden" id="customer_id"  name="customer_id">
                                                </div>

                                                <div class="form-group mx-1">
                                                    <label for="">Customer</label>
                                                    <select name="customers" id="customers" class="form-control selectcustomer"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mx-1">
                                                    ...
                                                    <input type="text" id="showcustomeremail" class="form-control ">
                                                </div>
                                                <div class="form-group mx-1">
                                                    <label for="">Address</label>
                                                    <input type="text" id="showcustomeraddress" class="form-control ">
                                                </div>
                                                
                                                <div class="form-group mx-1">
                                                    <label for="">Vat No</label>
                                                    <input type="text" id="showcustomervat" class="form-control ">
                                                </div>
                                                <div class="form-group mx-1">
                                                    <label for=""> Previous Due</label>
                                                    <input type="text" id="showcustomerdue" class="form-control " readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mx-1">
                                ...
                                <input type="date" id="orderdate" name="orderdate" value="{{date('Y-m-d')}}" class="form-control ">
                            </div>
                            <div class="form-group mx-1">
                            ...
                            <div class="form-group mx-1">
                                ...
                                <input type="text" id="ref" class="form-control " placeholder="Refecence">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mx-1 flex-fill">
                                        ...
                                        <input type="number" id="net_vat_amount" name="net_vat_amount" class="form-control"  style="flex: 0.6;" readonly>
                                    </div>
                                ...
                                <div class="col-lg-6 ">
                                    <div class="form-group mx-1 flex-fill">
                                        ...
                                        <input type="number" id="grand_total" name="grand_total" class="form-control "  style="flex: 0.6;" readonly>
                                    </div>
                                    <div class="form-group mx-1 flex-fill">
                                        <label for="">Net Amount</label>
                                        <input type="number" id="net_total" name="net_total" class="form-control"  style="flex: 0.6;" readonly>
                                    </div>
                                    <div class="form-group mx-1 flex-fill">
                                        <label for="">Customer Paying</label>
                                        <input type="number" id="customer_paid" name="customer_paid" class="form-control" style="flex: 0.6;">
                                    </div>
                                    <div class="form-group mx-1 flex-fill">
                                        <label for="">Due</label>
                                        <input type="number" id="due" name="due" min="0" class="form-control"  style="flex: 0.6;" readonly>
                                    </div>
                                    <div class="form-group mx-1 flex-fill">
                                        <label for="">Return Amount</label>
                                        <input type="number" id="return_amount" name="return_amount"  style="flex: 0.6;" class="form-control" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        @if(Auth::user()->type == '1' && in_array('9', json_decode(Auth::user()->role->permission)) || Auth::user()->type == '0' && in_array('9', json_decode(Auth::user()->role->permission)))
                                            <button class="btn btn-theme mt-2" id="addQuotation" type="button">Make Quotation</button>
                                        @endif
                                        ...
                                        <button class="btn btn-theme mt-2" id="addDeliveryNote" type="button">Make Delivery Note</button>
                                        @endif
                                        ...
                                        <button class="btn btn-theme mt-2" id="addOrderBtn" type="button">Make Sales</button>
                                        @endif
                                    </div>
                                </div> 
                            </div> 
...
<script type="text/javascript">
        ...
        $("#branchstock-tab-pane").on('click','#transferBtn', function(){
   ...
   $(document).ready(function() {
       ...
       var orderurl = "{{URL::to('/order-store')}}";
        $("body").delegate("#addOrderBtn","click",function(event){
                event.preventDefault();
            ...
            var payment_amount = $("input[name='payment_amount[]']")
              .map(function(){return $(this).val();}).get();
            ...
            // console.log(product_id, paymentmethod, comment);
                ...
                $.ajax({
                    url: orderurl,
                    method: "POST",
                    data: {product_id,salestype,vat_percent,sellingprice,quantity,total,net_total,orderdate,customer_id,grand_total,customername,customeraddress,customervat,customervehicleno,customeremail,ref,discount_amount,vat_total,customer_paid,due,return_amount,due_date,comment,card_holder_name,card_number,partnoshow,paymentmethod,payment_amount},
        ...
        // add deliverynote
        var deliverynoteurl = "{{URL::to('/delivery-note-store')}}";
        $("body").delegate("#addDeliveryNote","click",function(event){
                event.preventDefault();

            var partnoshow= $("#partnoshow").val();
            var orderdate = $("#orderdate").val();
            var customer_id = $("#customer_id").val();
            var customername = $("#showcustomername").val();
            var customeraddress = $("#showcustomeraddress").val();
            ...
            var total = $("input[name='total[]']")
              .map(function(){return $(this).val();}).get();
                $.ajax({
                    url: deliverynoteurl,
                    method: "POST",
                    data: {product_id,vat_percent,sellingprice,quantity,total,net_total,orderdate,customer_id,grand_total,customername,customeraddress,customervat,customervehicleno,customeremail,ref,discount_amount,vat_total,customer_paid,due,return_amount,due_date,comment,card_holder_name,card_number,partnoshow},
        ...
        // add deliverynote end


        // add quotation
        var quotationurl = "{{URL::to('/quotation-store')}}";
        $("body").delegate("#addQuotation","click",function(event){
                event.preventDefault();
        ...
        var urlcustomer = "{{URL::to('/getcustomer')}}";
            ...
            var urlproductload = "{{URL::to('/admin/product/active')}}";
            product_load();
            function product_load() {
                $.ajax({
                    ...
                    success: function (response) {
                        $('#product').empty();
                        $('#product').append('<option selected value="" disabled>Select a Product</option>');
                        $.each(response, function (i, product) {
                            let namePartno = product.productname;
                            if (product.part_no) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == 303) {
                            $(".customermsg").html(response.message);
                        } else {
