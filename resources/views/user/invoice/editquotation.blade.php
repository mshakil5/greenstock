                            ...
                            <div class="box mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button class="btn btn-theme mt-2" id="updateQuotation" type="button">Update</button>
                                        @endif
                                        ...
                                        <button class="btn btn-theme mt-2" id="quotationToDeliveryNote" type="button">Make Delivery Note</button>
                                        @endif
                                        ...
                                        <button class="btn btn-theme mt-2" id="quotationToSales" type="button">Make Sales</button>
                                        @endif
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       var orderurl = "{{URL::to('/order-store')}}";
        $("body").delegate("#quotationToSales","click",function(event){
                event.preventDefault();
        ...
        $("body").delegate("#quotationToDeliveryNote","click",function(event){
                event.preventDefault();
            ...
            var order_id = $("#order_id").val();
            var orderdate = $("#orderdate").val();
            console.log(orderdate,order_id);
            var customer_id = $("#customer_id").val();
            var customername = $("#showcustomername").val();
            var customeraddress = $("#showcustomeraddress").val();
            var customervat = $("#showcustomervat").val();
            ...
            var total = $("input[name='total[]']")
              .map(function(){return $(this).val();}).get();
                $.ajax({
                    url: deliverynoteurl,
                    method: "POST",
                    data: {product_id,order_id,vat_percent,sellingprice,quantity,total,net_total,orderdate,customer_id,grand_total,customername,customeraddress,customervat,customervehicleno,customeremail,ref,discount_amount,vat_total,customer_paid,due,return_amount,due_date,comment,card_holder_name,card_number,partnoshow},
        ...
        // add quotation
        var quotationurl = "{{URL::to('/quotation-update')}}";
        $("body").delegate("#updateQuotation","click",function(event){
                event.preventDefault();
