                            ...
                            <div class="box mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button class="btn btn-theme mt-2" id="updateDeliveryNote" type="button">Update Delivery Note</button>
                                        @endif
                                        ...
                                        <button class="btn btn-theme mt-2" id="deliveryNoteToSales" type="button">Make Sales</button>
                                        @endif
                                </div>
                                </div> 
                            </div> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       var orderurl = "{{URL::to('/order-store')}}";
        $("body").delegate("#deliveryNoteToSales","click",function(event){
                event.preventDefault();
            ...
            var delivery_note_id= $("#order_id").val();
        ...
        // update deliverynote
        var deliverynoteurl = "{{URL::to('/delivery-note-update')}}";
        $("body").delegate("#updateDeliveryNote","click",function(event){
                event.preventDefault();
